            ...
            <div id="general-settings-page" className={`pt-28 px-6 md:px-12 pb-24 min-h-[85vh] max-w-4xl mx-auto space-y-8 text-left ${
              ...
              <div className="bg-[#121212] border border-zinc-800 rounded-xl p-5 md:p-6 space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] text-zinc-500 text-left mt-2">
                    Silently reduces disk space by 50% using background transcoding when the server is idle. 'Auto' will only run if your server has 4+ CPU Cores to protect performance.
                  </p>
                </div>
              </div>
