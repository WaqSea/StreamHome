...
function ProfileControl({ profile, onProfiles, onLogout, placement = "bottom-end" }: Pick<ThemeNavigationProps, "profile" | "onProfiles" | "onLogout"> & { placement?: ProfileMenuPlacement }) {
